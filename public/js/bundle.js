      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Welcome to BookMyTrip, ".concat(name));
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
try {
  stripe = Stripe("pk_test_51Hcx5OGZJA7BkPdNQfURvcX3gBlEU9BuQjp8lUWIn7tCQ0ABEMDuRJSeBX17IIe1rhllVnXW2B0ANe3UOffXA6s900JKjzhbuy");
} catch (err) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review Submitted');
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
if (resetForm) {
  resetForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var urlPart = location.pathname.substr(location.pathname.lastIndexOf('/') + 1);
    (0, _forgotPassword.resetPassword)(document.getElementById('password').value, document.getElementById('passwordConfirm').value, urlPart);
  });
}
