...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var htmlString = "<div class='alert alert--".concat(type, "'>").concat(message, "</div>");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/users/login"),
              data: {
                email: email,
                password: password
              }
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Hello there, Just logging you in!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/users/logout")
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/users/signUp"),
              data: {
                name: name,
                email: email,
                password: password,
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Welcome to Natours, ".concat(name));
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //Extend map bounds to include current location 
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/users/forgotPassword"),
              data: {
                email: email
              }
            });
          ...
          case 3:
            response = _context.sent;
            if (response.data.status === 'success') (0, _alerts.showAlert)('success', response.data.message);
            _context.next = 10;
            break;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/users/resetPassword/").concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password is reset now');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/bookings/checkout-session/").concat(tourId));
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Payment Failed,please try again later');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"makeReview.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(window.location.protocol, "//").concat(window.location.host, "/api/v1/tours/").concat(tourId, "/reviews"),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            response = _context.sent;
            if (response.data.status === 'success') (0, _alerts.showAlert)('success', 'Review Submitted');
            _context.next = 11;
            break;
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error in submitting review');
...
var _makeReview = require("./makeReview");
...
if (bookingButton) {
  bookingButton.addEventListener('click', function () {
    ...
    var tourId = bookingButton.dataset.tourId;
...
if (searchTours) {
  var divArr = document.querySelectorAll('.card');
  var nameArr = [];

  var _iterator = _createForOfIteratorHelper(divArr),
      _step;
  ...
  searchTours.addEventListener('keyup', function (event) {
    container.innerHTML = "";
    var searchTour = searchTours.querySelector('.nav__search-input').value;

    for (var i = 0; i < 9; i++) {
      if (searchTour === '' || nameArr[i].includes(searchTour.toLowerCase())) container.appendChild(divArr[i]);
    }
  });
}
...
var loginForm = document.getElementById('loginForm'),
    ...
    userDetailsUpdate = document.getElementById('userDetailsUpdate'),
...
if (forgotForm) {
  forgotForm.addEventListener('submit', function (event) {
    event.preventDefault();
    (0, _forgotPassword.forgotPassword)(document.getElementById('email').value);
  });
}
...
if (resetForm) {
  resetForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var urlPart = location.pathname;
    (0, _forgotPassword.resetPassword)(document.getElementById('password').value, document.getElementById('passwordConfirm').value, urlPart.substr(urlPart.lastIndexOf('/') + 1));
  });
}

var logOutLink = document.querySelector('.nav__el--logout');

if (logOutLink) {
  logOutLink.addEventListener('click', _login.logout);
}

var reviewForm = document.getElementById('reviewForm');

if (reviewForm) {
  var starArr = ['one', 'two', 'three', 'four', 'five'];
  var rating = 0;
